    ...
    int raw;
{
    ...
    wtof("%s:   zipfi                   %p", __func__, zipfi);
    wtof("%s:   extrafield_local        %p", __func__, extrafield_local);
    wtof("%s:   size_extrafield_local   %u", __func__, size_extrafield_local);
    wtof("%s:   extrafield_global       %p", __func__, extrafield_global);
    wtof("%s:   size_extrafield_global  %u", __func__, size_extrafield_global);
    wtof("%s:   comment                 %s", __func__, comment);
    wtof("%s:   method                  %d", __func__, method);
    wtof("%s:   level                   %d", __func__, level);
    wtof("%s:   raw                     %d", __func__, raw);
#endif
